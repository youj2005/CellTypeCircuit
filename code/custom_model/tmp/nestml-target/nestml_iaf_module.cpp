...
nestml_iaf_module nestml_iaf_module_LTX_mod;
#endif

// -- DynModule functions ------------------------------------------------------

nestml_iaf_module::nestml_iaf_module()
{
#ifdef LINKED_MODULE
...
const std::string
nestml_iaf_module::name(void) const
{
  return std::string("nestml_iaf_module"); // Return name of the module
}
...
nestml_iaf_module::init( SLIInterpreter* i )
{
    ...
    nest::kernel().model_manager.register_node_model<iaf_cond_exp_dend_nestml>("iaf_cond_exp_dend_nestml");
  

  

} // nestml_iaf_module::init()